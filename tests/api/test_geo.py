...
_GET_CITY_XFAIL_REASON = (
    "live /get-city endpoint currently returns 500 for all coordinates, a known upstream degradation, not a test defect"
)


@pytest.mark.xfail(reason=_GET_CITY_XFAIL_REASON)
@pytest.mark.smoke
